# Παράδειγμα: Απόδειξη Παροχής Υπηρεσιών 
...
$issuer = new Issuer();
$issuer->setVatNumber('888888888'); // Ο ΑΦΜ της επιχείρησής σας
...
> [!CAUTION]
> Οι Αποδείξεις Παροχής Υπηρεσιών είναι μή αντικριζόμενα παραστατικά και δεν απαιτούν την αναγραφή του λήπτη του παραστατικού.
