...
class SendStatementTest extends MyDataHttpTestCase
{
    ...
    public function test_it_sends_statement()
    {
        ...
        $fakeResponse->addResponse($responseStatement = ResponseStatement::factory()->make());
        ...
        $this->assertEquals($responseStatement->getStatementId(), $responseDoc->first()->getStatementId());
        $this->assertEquals($responseStatement->getStatusCode(), $responseDoc->first()->getStatusCode());
    }
}
