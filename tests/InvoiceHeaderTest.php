...
class InvoiceHeaderTest extends TestCase
{
    ...
    public function test_it_converts_invoice_header_to_xml(): void
    {
        ...
        $this->assertEquals($header->getInvoiceType(), $headerXml->invoiceType);
        ...
        $this->assertEquals($header->getMovePurpose(), $headerXml->movePurpose);
        $this->assertEquals($header->isFuelInvoice(), filter_var($headerXml->fuelInvoice, FILTER_VALIDATE_BOOLEAN));
        $this->assertEquals($header->getSpecialInvoiceCategory(), $headerXml->specialInvoiceCategory);
        $this->assertEquals($header->getInvoiceVariationType(), $headerXml->invoiceVariationType);
