...
class InvoiceIncomeClassificationType extends Type
{
    /**
     ...
     */
    public function getIncomeClassificationDetailData(): IncomeClassificationType
    {
        return $this->get('incomeClassificationDetailData');
    }

    /**
     * @param IncomeClassificationType $incomeClassificationType
     * @return $this
     */
    public function setIncomeClassificationDetailData(IncomeClassificationType $incomeClassificationType): self
    {
        return $this->put('incomeClassificationDetailData', $incomeClassificationType);
    }
}