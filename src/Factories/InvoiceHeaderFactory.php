...
class InvoiceHeaderFactory extends Factory
{
    public function definition(): array
    {
        return [
            ...
            'invoiceType'             => fake()->randomElement(InvoiceType::cases())->value,
            ...
            'movePurpose'             => fake()->word(),
            'fuelInvoice'             => fake()->boolean(),
            'specialInvoiceCategory'  => fake()->randomElement(SpecialInvoiceCategory::cases())->value,
            'invoiceVariationType'    => fake()->randomElement(InvoiceVariationType::cases())->value,
