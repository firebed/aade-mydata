...
enum InvoiceType: string
{
    ...
    */
    ...
    /**
     * Δελτίο Ποσοτικής Παραλαβής Μη Συσχετιζόμενο
     */
    case TYPE_10_2 = "10.2";
    ...
    */
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::TYPE_9_1 => "Δελτίο Αποστολής Συσχετιζόμενο",
            self::TYPE_9_2 => "Συγκεντρωτικό Δελτίο Αποστολής",
            self::TYPE_9_3 => "Παραστατικό Διακίνησης Μη Συσχετιζόμενο",
            self::TYPE_10_1 => "Δελτίο Ποσοτικής Παραλαβής Συσχετιζόμενο",
            self::TYPE_10_2 => "Δελτίο Ποσοτικής Παραλαβής Μη Συσχετιζόμενο",
            self::TYPE_11_1 => "ΑΛΠ",
            self::TYPE_11_2 => "ΑΠΥ",
